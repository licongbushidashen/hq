<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column min-width="300px" label="Banner名称">
        <template slot-scope="{ row }">
          <span>{{ row.title }}</span>
    ...
    >
      ...
      <div @click="isShowColors=false">
        <div>
          <div class="jdcx" style="margin-top: 0px">
            <label><span class="bt">*</span>Banner名称:</label>
            <el-input
              v-model="from.title"
              class="el_input_g"
              style="width: 350px"
        ...
        <div>
          ...
          <div class="jdcx" style="    margin: 20px 0px;    text-align: left;    margin-left: 49px;">
            <label style="margin-right: 6px;"><span class="bt">*</span>背景颜色:</label>
            <div
              style="display: inline-block; width: 360px"
              @click.stop="colorInputClick"
            >
              <el-input class="wy_disable" style="width:220px" disabled :value="from.bgColor" @click.stop="colorInputClick" />
            </div>
            <div
              v-show="isShowColors"
        ...
        <div>
          <div class="jdcx" style="width: 200px;">
            <label style="    margin-right: 30px;"><span class="bt">*</span>Banner图上传:</label>
            <el-upload
...
export default {
  ...
  methods: {
    ...
    addtype() {
      ...
      debugger
      if (!(data.title && data.bgColor && data.url && data.sortIndex && data.coverImage)) {
